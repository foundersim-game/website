...
export type ActionCategory =
    ...
    | "marketing_skill" | "health" | "burnout"
...
export const IMMEDIATE_ACTIONS: ActionDef[] = [
    ...
    // ── Technical Skill
    {
        ...
        impact: "+8 Tech, −5 Reliability risk, +10 Burnout",
        cooldownMonthly: 1,
        baseEffects: { technical_skill: 8, founder_burnout: 10, product_quality: 3 },
    ...
    },
    {
        ...
        impact: "+3 Tech, −5 Tech Debt",
        cooldownMonthly: 2,
        baseEffects: { technical_skill: 3, technical_debt: -5 },
    ...
    },
    {
        ...
        impact: "+3 Tech, +5 Reliability",
        cooldownMonthly: 3,
        baseEffects: { technical_skill: 3, reliability: 5, technical_debt: -3 },
    },
    {
        ...
        impact: "+4 Tech, prevents future debt",
        cooldownMonthly: 1,
        baseEffects: { technical_skill: 4, technical_debt: -8 },
    },
    {
        id: "write_tests",
        ...
        impact: "+2 Tech, +5 Reliability",
        cooldownMonthly: 2,
        baseEffects: { technical_skill: 2, reliability: 5 },
    },
    ...
    // ── Leadership
    {
        ...
        impact: "+3 Lead, +6 Morale",
        cooldownMonthly: 3,
        baseEffects: { leadership: 3, team_morale: 6 },
    ...
    },
    {
        ...
        impact: "+2 Lead, +5 Morale",
        cooldownMonthly: 2,
        baseEffects: { leadership: 2, team_morale: 5 },
    },
    {
        id: "set_okrs",
        label: "Set Team OKRs",
        ...
        impact: "+3 Lead, +8 Productivity",
        cooldownMonthly: 1,
        baseEffects: { leadership: 3, team_morale: 4, culture_score: 3 },
    },
    {
        id: "public_speaking",
    ...
    },
    {
        ...
        impact: "+5 Lead, +15 Morale, −$3000",
        cooldownMonthly: 1,
        baseEffects: { leadership: 5, team_morale: 15, culture_score: 8, founder_burnout: -10, cash: -3000 },
    },
    ...
    },
    {
        ...
        impact: "+1 Net, +1 Marketing",
        cooldownMonthly: 8,
        baseEffects: { networking: 1, marketing_skill: 1, brand_awareness: 1 },
    },
    {
        id: "speak_at_meetup",
    ...
    // ── Marketing Skill
    {
        ...
        impact: "+2 Mkt, −10% CAC",
        cooldownMonthly: 1,
        baseEffects: { marketing_skill: 2, brand_awareness: 3 },
    },
    {
        id: "write_case_study",
        ...
        tier: "immediate",
        energyCost: 6,
        description: "Document a customer success story",
        impact: "+2 Mkt, +2 Rep",
        cooldownMonthly: 1,
        baseEffects: { marketing_skill: 2, reputation: 2, brand_awareness: 2 },
    },
    {
        id: "deep_competitor_analysis",
        ...
        impact: "+4 Mkt, +strategic intel",
        cooldownMonthly: 1,
        baseEffects: { marketing_skill: 4, intelligence: 1 },
    },
    {
        id: "guest_blog_post",
        label: "Write Guest Blog Post",
        emoji: "✍️",
        category: "marketing_skill",
        tier: "immediate",
        energyCost: 5,
        description: "Publish on industry media",
        impact: "+2 Mkt, +brand",
        cooldownMonthly: 2,
        baseEffects: { marketing_skill: 2, brand_awareness: 4 },
    },
    {
        id: "user_interview",
        ...
        tier: "immediate",
        energyCost: 10,
        description: "Talk to customers about their problems",
        impact: "+2 Mkt, +PMF signal",
        cooldownMonthly: 2,
        baseEffects: { marketing_skill: 2, pmf_score: 3 },
        situationalBoosts: { low_pmf: 2.0 },
        situationalNote: { low_pmf: "🔥 2× — understanding users is your #1 priority right now" },
    },
    ...
    // ── Pre-existing Product & Marketing Actions ported to Immediate ──
    {
        ...
        impact: "+5 Quality, +4 Innovation, -1.5k Burn",
        cooldownMonthly: 3,
        baseEffects: { product_quality: 5, technical_debt: 8, innovation: 4, cash: -1000 },
    ...
    },
    {
        ...
        impact: "+10 Quality, +Users",
        cooldownMonthly: 2,
        baseEffects: { product_quality: 10, technical_debt: 5, users: 50, cash: -2000 },
    },
    {
        ...
        impact: "-20 Debt, +5 Rel",
        cooldownMonthly: 2,
        baseEffects: { technical_debt: -20, reliability: 5 },
    ...
    },
    {
        ...
        impact: "+10 Rel, -5 Debt",
        cooldownMonthly: 4,
        baseEffects: { reliability: 10, technical_debt: -5 },
    },
    {
        id: "optimize_cloud",
        ...
        impact: "-$500 Cash, +5 Rel",
        cooldownMonthly: 1,
        baseEffects: { cash: -500, reliability: 5 },
    },
    // Marketing
    {
        id: "organic_social",
    ...
    },
    {
        ...
        impact: "+2 Brand, +50 Users",
        cooldownMonthly: 2,
        baseEffects: { brand_awareness: 2, users: 50 },
    },
    {
        id: "paid_acquisition",
        ...
        impact: "-2k Cash, +400 Users",
        cooldownMonthly: 5,
        baseEffects: { cash: -2000, users: 400 },
    },
    {
        id: "pr_campaign",
        label: "PR Campaign",
        ...
        impact: "-5k Cash, +10 Brand, +Rep",
        cooldownMonthly: 1,
        baseEffects: { cash: -5000, brand_awareness: 10, reputation: 5 },
...
export const ONGOING_PROGRAMS: OngoingProgramDef[] = [
    ...
    // ── Marketing Programs
    {
        ...
        monthlyCost: 500,
        monthlyEnergy: 4,
        baseMonthlyEffect: { brand_awareness: 3, users: 100 },
    ...
    },
    {
        ...
        monthlyCost: 0,
        monthlyEnergy: 3,
        baseMonthlyEffect: { brand_awareness: 2, networking: 1 },
    ...
    },
    {
        ...
        monthlyCost: 100,
        monthlyEnergy: 2,
        baseMonthlyEffect: { brand_awareness: 2, users: 50 },
    ...
    },
    {
        ...
        monthlyCost: 0,
        monthlyEnergy: 5,
        baseMonthlyEffect: { brand_awareness: 4, networking: 2, reputation: 1 },
